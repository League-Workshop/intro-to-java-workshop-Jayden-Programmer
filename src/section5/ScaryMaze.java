...
maze = ImageIO.read(getClass().getResource("maze.png"));
	...
	public void mouseMoved(MouseEvent e) {
		...
		int backgroundRed=-3790808;
		int backgroundWhite=0;
		int backgroundblue =-14575885;
		int backgroundBlack =-16777216;
		//8. If the mouse falls off the path (if it is on the background)
		if(mouseColor == backgroundBlack) {
		
			scare();
		}
		if (mouseColor == backgroundblue) {
