...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		JOptionPane.showMessageDialog(null, "Piranhas are attracted to fresh" + liquid + "and will most likely take a bit out of your\n" + bodypart + "if you\n" + verb + "Whatever you do, if you have an open wound,find another way to get back to the" + Place + good luck!");
